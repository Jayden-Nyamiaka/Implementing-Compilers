...
let passes =
  ["lvar"; "un"; "rc"; "ec"; "si"; "ul"; "bi"; "ar"; "pi"; "pc"; "pa"]
    ...
    match !pass with
      | "lvar" ->
        begin
          ...
          else  (* same with -only as without *)
      ...
      | "un" ->
        begin
          if !eval then
            ...
            read_lvar filename |> un |> lvar_out |> print_sexp
        end
      ...
      | "rc" ->
        begin
          if !eval then
            ...
            read_lvar filename |> un |> rc |> lvar_mon_out |> print_sexp
        end
      ...
      | "ec" ->
        begin
          if !eval then
            ...
            read_lvar filename |> un |> rc |> ec |> cvar_out |> print_sexp
        end

      | "si" ->
        begin
          if !eval then
            Printf.printf "no evaluator for this pass\n"
          else if !only then
            read_sexp filename |> cvar_in |> si
              |> x86_var1_out |> print_sexp
          else
            read_lvar filename |> un |> rc |> ec |> si
              |> x86_var1_out |> print_sexp
        end
      ...
      | "ul" ->
        begin
          if !eval then
            ...
            read_sexp filename |> x86_var1_in |> ul
              |> x86_var2_out |> print_sexp
          else
            read_lvar filename |> un |> rc |> ec |> si |> ul
              |> x86_var2_out |> print_sexp
        end
      ...
      | "bi" ->
        begin
          if !eval then
            ...
            read_sexp filename |> x86_var2_in |> bi
              |> x86_var3_out |> print_sexp
          else
            read_lvar filename |> un |> rc |> ec |> si |> ul |> bi
              |> x86_var3_out |> print_sexp
        end
      ...
      | "ar" ->
        begin
          if !eval then
            ...
            read_sexp filename |> x86_var3_in |> ar
      ...
      | "pi" ->
        begin
          if !eval then
            ...
            read_sexp filename |> x86_var4_in |> pi
              |> x86_int_out |> print_sexp
          else
            read_lvar filename
              |> un |> rc |> ec |> si |> ul |> bi |> ar |> pi
              |> x86_int_out |> print_sexp
        end
      ...
      | "pc" ->
        begin
          if !eval then
            ...
            read_sexp filename |> x86_int_in |> pc
              |> x86_asm_out |> print_sexp
          else
            read_lvar filename
              |> un |> rc |> ec |> si |> ul |> bi |> ar |> pi |> pc
              |> x86_asm_out |> print_sexp
        end
